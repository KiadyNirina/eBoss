<script>
    ...
    $: isDisabled = !(name, address, school_number, email) || errorName || errorAddress || errorNumber || errorEmail 
            ...
            <form>
                {#if info1}
                    <div class="two">
                        <div class="name">
                            <label for="">Nom :</label>
                            <input type="text" name="" id="" placeholder="Entrer le nom de l'établissement" bind:value={name} on:input={validName}>
                            {#if errorName}
                        ...
                        <div class="name">
                            ...
                            <input type="text" name="" id="" placeholder="Entrer l'adresse de l'établissement" bind:value={address} on:input={validAddress}>
                            {#if errorAddress}
                    ...
                    <div class="one">
                        ...
                        <input type="text" name="" id="" placeholder="Entrer le numéro du mobile de l'établissement" bind:value={school_number} on:input={validNumber}>
                        {#if errorNumber}
                ...
                {:else if info2}
                    <div class="one">
                        ...
                        <select name="" id="" bind:value={school_type} on:select={validType}>
                            <option value="" disabled>Selectionnez le type de l'établissement</option>
                    ...
                    <hr>
                    <div class="one">
                        <label for="">Niveaux scolaires :</label>

                        <div class="check">
                            <label for="">Ecole
                                <input type="checkbox" value="Ecole" on:change={() => toggle_level('Ecole')} name="" id="">
                            </label>

                            <label for="">Collège
                                <input type="checkbox" value="College" on:change={() => toggle_level('College')} name="" id="">
                            </label>
                        </div>
                        <div class="check">
                            <label for="">Lycée
                                <input type="checkbox" value="Lycee" on:change={() => toggle_level('Lycee')} name="" id="">
                            </label>

                            <label for="">Enseignement supérieur
                                <input type="checkbox" value="Universite" on:change={() => toggle_level('Universite')} name="" id="">
                            </label>
                        </div> 
                        {#if errorLevel}
                            <span class="error">{errorLevel}</span>
                        {/if}
                    </div><hr>
                    ...
                    <div class="one">
                        ...
                        <div class="two">
                            {#if selected_classes.length > 0}
                                <div class="classe">
                                    {#each selected_classes as classOption}
                                    <ul>
                ...
                {:else if info2}
                    <div class="two">
                        ...
                        <button on:click={lastHandleClick} disabled={isDisabled2}>Suivant</button>
                    </div>                
                {:else}
                    <div class="two">
