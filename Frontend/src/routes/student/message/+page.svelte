<script>
    ...
    import NavMess from "../../../lib/navStudent/navMess.svelte";
...
<div class="content">
    ...
    <div class="content-body">
        ...
        <div class="body">
            <a href="/school/message/students/content">
                <div class="profile">
                    <img src="/img/picture.png" alt="">
                    <div class="info">
                        <span><b>{user.school_name}</b></span><br>
                        <span id="fonction">Classe: {user.school_classes}</span>
                    </div>
                </div>
            </a>
        </div>
