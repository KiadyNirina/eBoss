<script>
    ...
    const countStudents = async () => {
        const response = await fetch(`http://localhost:8000/school/countStudents/${user.school_name}/`);
        const data = await response.json();
...
<div class="content">
    ...
    <div class="content-body">
        ...
        <div class="add">
            <button>
                <a href="/school/list/teachers/add">
                    <img src="/icons/ajouter.png" alt="">
                    <span>Ajouter un(e) enseignant(e)</span>
                </a>
            </button>
        </div>
        ...
        <div class="body">
            <span><u>Nombres total des enseignants</u> : {$studentsCount}</span>
