    ...
    <div class="content-body">
        ...
        {:else}
                ...
                <div class="content-post">
                    <div class="add">
                        <button>
                            <a href="/school/home/announcement/add">
                    ...
                    <div class="container">
                        <a href="" class="profil">
                            ...
                            <div class="name">
                                <span>{user.username}</span><br>
                                <span class="see">Date: 25-12-2024</span>
                            </div>
                        </a>
                        <div class="post">
                    ...
                    <div class="container">
                        <a href="" class="profil">
                            ...
                            <div class="name">
                                <span>{user.username}</span><br>
                                <span class="see">Date: 07/06/2024</span>
                            </div>
                        </a>
                        <div class="post">
                            <p>Programme fin d'année : <br>
                                - Semaine du 10 juin : correction d'examen et répétition de la fête <br>
                                - Semaine de 17 juin : répétition générale <br>
                                - Vendredi 21 juin : - à 7h:30 : grand carnaval <br>
                                                    - à 10h : fête de l'école à Anstahamanitra. (pour toute la journée)
                            </p>
                            <div class="action">
                                <a href=""><img src="/icons/modifier.png" alt=""></a>
                                <a href=""><img src="/icons/supprimer.png" alt=""></a>
