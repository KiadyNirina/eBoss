...
<div class="content">
    ...
    <div class="content-body">
        ...
        <div class="body">
            <a href="/school/message/parents/content">
                <div class="profile">
                    <img src="/icons/profile.png" alt="">
                    <div class="info">
                        <span><b>ANDRIANASOLO Helisoa Olivia</b></span><br>
                        <span id="fonction">Parent de: RAMBELOSON Kiady Mandresy | Classe: 5eme</span>
                    </div>
                </div>
            </a><hr>
        </div>
